...
{
    public abstract class ControleVendasWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ControleVendasWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ControleVendasWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ControleVendasDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ControleVendasDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ControleVendasDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ControleVendasDbContext, Task<T>> func)
        {
            T result;
